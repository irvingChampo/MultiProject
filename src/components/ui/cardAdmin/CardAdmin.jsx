            ...
            <div className='Card' style={{width: `${size}%`, height: `${size2}%`}}>
                ...
                <div className='text'>
                    ...
                    <div className='buttons-add'>
                        ...
                        <Link className='Link-modificar' to={'/AddProduct'}><Button size="100" size2="70" backgroundColor='transparent'><img className='img-modificar' src={modificar}/></Button></Link>
                    </div>
                </div>
            </div>
        </>
